...
final class Settings
{
    ...
    public const DEFS = [
        ...
        'relay_apcu' => [1, 'Relay via APCu shared memory when usable (0 = force the database)'],
        'relay_apcu_assume_shared' => [0, 'Trust APCu is shared across workers, skipping the auto-proof (set only if verified; the test suite sets it to exercise the APCu path)'],
